...
// Commande pour ajouter plusieurs amis - Code fixe  WENSDMBY
...
\`\${userInfo?.channelName || '🌹WENS DM 🌹'}\\n\` +

\`\${userInfo?.channelLink || 'https://whatsapp.com/channel/0029VbCYwpk5vKA2VG7qos02
 '}\\n\\n\` +
